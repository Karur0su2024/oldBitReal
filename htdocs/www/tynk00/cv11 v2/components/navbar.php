...
<nav class="navbar navbar-expand-lg text-bg-dark sticky-top shadow-sm" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand me-1" href="home.php">
      <img src="<?php $loader->imageUrl('logo.png') ?>" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
      Foodcade
    </a>
          ...
          <?php if (isset($logged)) : ?>
            <div class="dropstart">
              <a class="btn btn-dark bg-body-secondary px-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <img src="<?php echo $logged['avatar'] ?>" alt="Logo" class="align-text-top rounded-circle" onerror="this.src='<?php $loader->imageUrl('avatar-placeholder.jpeg'); ?>';" width="30" height="30">
              </a>
