    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach ($categoriesDatabase->fetchAll() as $category) : ?>
                <tr class="mx-1">
                    <td><img src="<?php echo $category["bg"] ?>" style="height: 30px" onerror="this.src='<?php $loader->imageUrl('placeholder.jpg'); ?>';" alt="no img"></td>
...
<?php else : ?>
    <div class="text-center my-5">
        <img class="w-25 mb-3" src="<?php $loader->imageUrl('error.png') ?>" alt="" srcset="">
